...
function SignupForm() {
   ...
   return (
      <div className="w-1/2 flex flex-col justify-center items-start">
         <h2 className="text-3xl font-bold text-orange-400 mb-1 ml-8 mt-8">Sign Up</h2>
            ...
            {() => (
               <Form className=" pt-8 pl-8 pr-8 w-full max-w-md">
                  ...
                  <div className="flex flex-col mb-4">
                     ...
                     <Field type="text" name="username" className="w-full bg-gray-200 rounded-lg px-4 py-2" />
                     <ErrorMessage className="text-red-700" name="username" component="span" />
                  </div>
                  <div className="flex flex-col mb-4">
