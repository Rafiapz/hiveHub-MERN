            ...
            <div style={{width:'800px'}} className="user-profile mt-1 bg-white rounded-lg shadow-lg h-full relative">
                ...
                <div className="flex justify-between profile-info ">
                    ...
                    <div className="profile-actions ">
                        <button onClick={handleEditProfile} className="edit-profile-button bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded mr-2">Edit Profile</button>
